...
# Factor method st_yr end_yr 
 1 1 2023 2024 # natmort; use:  1 1 2023 2024
 4 1 2021 2024 # recr_dist; use:  4 1 2021 2024
 10 1 -999 0 # selectivity; use:  10 1 1962 2024
 11 1 -3 0 # rel_F; use:  11 1 2021 2024
 12 1 2021 2024 # recruitment; use:  12 1 2021 2024
-9999 0 0 0
#
...
0.35 # Control rule inflection for constant F (as frac of Bzero, e.g. 0.40); must be > control rule cutoff, or set to -1 to use Bmsy/SSB_unf 
...
3 # basis for fcast catch tuning and for fcast catch caps and allocation  (2=deadbio; 3=retainbio; 5=deadnum; 6=retainnum); NOTE: same units for all fleets
